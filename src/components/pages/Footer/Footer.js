    ...
    <div className='footer-container'>
      ...
      <div className='footer-links'>
        <div className='footer-link-wrapper'>
          ...
          <div className='footer-link-items'>
            <h2>Contact Us</h2>
            <a><MdEmail className='navbar-icon'/>plmssc.chaw@gmail.com</a>
            <a><MdEmail className='navbar-icon'/>theplm.ssc@gmail.com</a>
            <a><MdLocationOn className='navbar-icon'/>Manila, Philippines</a>
        ...
        <div className='footer-link-wrapper'>
          ...
          <div className='footer-link-items'>
            <h2>Social Media</h2>
            <a target="_blank" href="https://www.instagram.com/plm.edu.ph/">Instagram</a>
            <a target="_blank" href="https://www.facebook.com/plmssc">Facebook</a>
            <a target="_blank" href="https://twitter.com/PLM_Manila">Twitter</a>
          </div>
        </div>
      </div>
